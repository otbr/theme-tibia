    ...
    <div class="inner-box-border">
        <div class="inner-box">
            ...
            <p>
                ...
                <br>
                In view of all this, the adventurers decided they had to guard the crystal portal they had found against the monsters that are also drawn to the source of the strange magical call, and welcome new heroes to Tibia.
                <br>
                As the adventurers are small in numbers, they had to include the new heroes in their tasks, and so anyone new to Tibia can help them in their quest and fight off the monsters by taking up the arms of a vocation - at least until they are experienced enough to venture forth to the mainland, where the guild can always use new hands in facing new challenges, or where the now hardened adventurers can explore Tibia on their own.
            </p>
