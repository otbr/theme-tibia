...
return [
    ...
    'registration.accept.edit'      => 'Edit',
    'registration.accept.heading'   => 'A request has been submitted to change your registration!',
    'registration.accept.content'   => 'You can now confirm the changes of the registration to finalise them.<br>
                                        Please cancel the request if you do not want your registration to be changed!',
    ...
    'email.accept.edit'             => 'Edit',
    'email.accept.heading'          => 'There is an email change request for the account!',
    'email.accept.content'          => 'A request has been submitted to change the email address of this account to 
                                        <strong>:email</strong>. You can now accept the new email address finally. Please 
                                        cancel the request if you do not want your email address to be changed! Also cancel 
                                        the request if you have no access to the new email address!',
